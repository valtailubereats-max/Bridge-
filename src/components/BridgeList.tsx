    ...
    <div className="fixed inset-0 z-40 bg-slate-900 flex flex-col h-full animate-in slide-in-from-bottom duration-300">
      ...
      <div className="px-6 py-5 bg-slate-950 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center space-x-2.5">
          ...
          <h2 className="text-xl font-bold text-white font-sans">Banco de Pontes ({groupedList.length} locais)</h2>
        </div>
        <button
          onClick={onClose}
          className="px-4 py-2 bg-slate-800 hover:bg-slate-700 active:bg-slate-900 rounded-xl font-bold text-xs text-slate-200 cursor-pointer"
          id="btn-close-list"
        >
          Voltar
        </button>
      ...
      <div className="p-4 bg-slate-950/40 border-b border-slate-800 space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 pl-11 pr-4 bg-slate-900 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500"
